...
function unosDodaj() {
  ...
  if (!validirajDodaj(cijena, 1)) {
    poruka.innerHTML = "Pogrešan format cijene! Napomena: Unesite potpunu cijenu(primjer: 4.00, 4 ...)";
    return false;
  }
...
function unosEdit() {
  ...
  if (naziv ="" || cijena == "" || slika == "") {
    poruka.innerHTML = "Neko od polja je prazno! Ako ne želite mijenjati vrijednost, ostavite početnu.";
    return false;
  }
  if (!validirajDodaj(naziv, 0)) {
    poruka.innerHTML = "Pogrešan format naziva! Napomena: Dopušteno korištenje slova, brojeva, razmaka i tačke.";
